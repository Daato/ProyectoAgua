<?php
  ...
  $vcontraseña = $datos[0]['contraseña'];
...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="<?php echo base_url(); ?>/">
                            <img src="../assets/images/icon/lorem.png" />
                        </a>
        ...
        <div class="input-group mb-3">
          <input value="<?php echo $vcontraseña ?>" id="contraseña" name="contraseña" type="password" class="form-control" placeholder="Contraseña">
          <div class="input-group-append">
          </div>
        </div>
