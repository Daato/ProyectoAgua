    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
          ...
          <div class="auth-form-container text-start mx-auto">
            <form action="<?php echo base_url(); ?>/Registrar_producto" method="post"  enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
          <input id="tipo" name="tipo" type="text" class="form-control" placeholder="Categoria">
          <div class="input-group-append">
          </div>
        </div>
        <div class="input-group mb-3">
