<?php
  ...
  $vcorreo = $datos[0]['correo'];
  $vtelefono = $datos[0]['telefono'];
   $vrfc = $datos[0]['rfc'];
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
          ...
          <div class="auth-form-container text-start mx-auto">
            <form action="<?php echo base_url(); ?>/actualizar_proveedor" method="post"  enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
          <input value="<?php echo $vcorreo ?>" id="correo" name="correo" type="text" class="form-control" placeholder="Correo">
          <div class="input-group-append">
          </div>
        </div>
        <div class="input-group mb-3">
          <input value="<?php echo $vtelefono ?>" id="telefono" name="telefono" type="text" class="form-control" placeholder="telefono">
          <div class="input-group-append">
          </div>
        </div>
        <div class="input-group mb-3">
          <input value="<?php echo $vrfc ?>" id="rfc" name="rfc" type="text" class="form-control" placeholder="rfc">
          <div class="input-group-append">
          </div>
        </div>
