<?php
  $vid = $datos[0]['id'];
  $vnombre = $datos[0]['nombre'];
  $vtipo = $datos[0]['tipo'];
  $vdescripcion = $datos[0]['descripcion'];
   $vprecio = $datos[0]['precio'];
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
          ...
          <div class="auth-form-container text-start mx-auto">
            <form action="<?php echo base_url(); ?>/actualizar_producto" method="post"  enctype="multipart/form-data">
        <div class="input-group mb-3">
          <input value="<?php echo $vid ?>" id="id" name="id" type="text" class="form-control" placeholder="id">
          <div class="input-group-append">
          </div>
        </div>
        <div class="input-group mb-3">
          <input value="<?php echo $vnombre ?>" id="nombre" name="nombre" type="text" class="form-control" placeholder="Nombre">
          <div class="input-group-append">
          </div>
        </div>
        <div class="input-group mb-3">
          <input value="<?php echo $vtipo ?>" id="tipo" name="tipo" type="text" class="form-control" placeholder="Categoria">
          <div class="input-group-append">
          </div>
        </div>
        <div class="input-group mb-3">
          <input value="<?php echo $vdescripcion ?>" id="descripcion" name="descripcion" type="text" class="form-control" placeholder="Descripcion">
          <div class="input-group-append">
          </div>
        </div>
        <div class="input-group mb-3">
          <input value="<?php echo $vprecio ?>" id="precio" name="precio" type="text" class="form-control" placeholder="Precio">
          <div class="input-group-append">
          </div>
        </div>
        <div class="input-group mb-3">
          <p class="text-danger login-box-msg"></p>
          <input type="file" id="imagenproducto" name="imagenproducto" accept="image/png">
        </div>
