...
<div class="container mt-5">
  <div class="row mt-3">
     <table class="table table-strip" id="users">
       <thead>
          <tr>
            <th></th>
             <th>ID</th>
       ...
       <tbody>
          ...
          <tr>
            ...
            <td><img width="100px" height="60px" src="<?php echo base_url(); ?>/../public/imagenes/<?php echo $row['nombre'];?>.png" class="logo-lg" alt="Not Found"></td>
             ...
             <td>
              ...
              <button class="btn btn-warning btn-sm"><a style="color:white" href="<?php echo base_url().'/editar_producto/'.$row['id']; ?>" class="editar-modal">Editar</a></button>

              <br><button class="btn btn-danger btn-sm"><a style="color:white" href="<?php echo base_url().'/eliminar_producto/'.$row['id']; ?>">Eliminar</a></button>
              </td>
          </tr>
         <?php endforeach; ?>
         <?php endif; ?>
         <td colspan="7" align="right"></td>
  <td>              <button class="btn btn-success btn-sm"><a style="color:white" href="<?php echo base_url(); ?>/crear_producto">Ingresar</a></button></td>
       </tbody>
     </table>
  </div>
</div>
