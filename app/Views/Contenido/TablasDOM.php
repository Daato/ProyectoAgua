     ...
     <table class="table table-strip" id="users">
       ...
       <tbody>
          ...
          <tr>
            ...
            <td><img width="100px" height="60px" src="<?php echo base_url(); ?>/../public/usuarios/<?php echo $row['nombre'];?>.png" class="logo-lg" alt="Not Found"></td>
             <td><?php echo $row['nombre']; ?></td>
             <td><?php echo $row['correo']; ?></td>
             <td><?php echo $row['contraseña']; ?></td>
             <td>

              <button class="btn btn-warning btn-sm"><a style="color:white" href="<?php echo base_url().'/editar_usuario/'.$row['id']; ?>" class="editar-modal">Editar</a></button>

              <button class="btn btn-danger btn-sm"><a style="color:white" href="<?php echo base_url().'/eliminar_usuario/'.$row['id']; ?>">Eliminar</a></button>
              </td>
          </tr>
         <?php endforeach; ?>
         <?php endif; ?>
         <td colspan="5" align="right"></td>
  <td>              <button class="btn btn-success btn-sm"><a style="color:white" href="<?php echo base_url(); ?>/crear_usuario">Ingresar</a></button></td>
       </tbody>
     </table>
  </div>
</div>
