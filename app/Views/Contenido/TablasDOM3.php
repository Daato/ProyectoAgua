          ...
          <tr>
            ...
            <td><?php echo $row['id']; ?></td>
             ...
             <td>
              ...
              <button class="btn btn-warning btn-sm"><a style="color:white" href="<?php echo base_url().'/editar_proveedor/'.$row['id']; ?>" class="editar-modal">Editar</a></button>

              <button class="btn btn-danger btn-sm"><a style="color:white" href="<?php echo base_url().'/eliminar_proveedor/'.$row['id']; ?>">Eliminar</a></button>
              </td>
          </tr>
         <?php endforeach; ?>
         <?php endif; ?>
         <td colspan="5" align="right"></td>
  <td>              <button class="btn btn-success btn-sm"><a style="color:white" href="<?php echo base_url(); ?>/crear_proveedor">Ingresar</a></button></td>
       </tbody>
     </table>
  </div>
</div>
